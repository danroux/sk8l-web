...
goog.exportSymbol('proto.sk8l.JobList', null, global);
...
goog.exportSymbol('proto.sk8l.MappedJobs', null, global);
 ...
 * @constructor
 */
proto.sk8l.JobList = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.sk8l.JobList.repeatedFields_, null);
};
goog.inherits(proto.sk8l.JobList, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.sk8l.JobList.displayName = 'proto.sk8l.JobList';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.sk8l.MappedJobs = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.sk8l.MappedJobs, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.sk8l.MappedJobs.displayName = 'proto.sk8l.MappedJobs';
}
 ...
 * @const
 */
proto.sk8l.JobList.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.sk8l.JobList.prototype.toObject = function(opt_includeInstance) {
  return proto.sk8l.JobList.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.sk8l.JobList} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sk8l.JobList.toObject = function(includeInstance, msg) {
  var f, obj = {
    itemsList: jspb.Message.toObjectList(msg.getItemsList(),
    k8s_io_api_batch_v1_generated_pb.Job.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.sk8l.JobList}
 */
proto.sk8l.JobList.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.sk8l.JobList;
  return proto.sk8l.JobList.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.sk8l.JobList} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.sk8l.JobList}
 */
proto.sk8l.JobList.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new k8s_io_api_batch_v1_generated_pb.Job;
      reader.readMessage(value,k8s_io_api_batch_v1_generated_pb.Job.deserializeBinaryFromReader);
      msg.addItems(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.sk8l.JobList.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.sk8l.JobList.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.sk8l.JobList} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sk8l.JobList.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      k8s_io_api_batch_v1_generated_pb.Job.serializeBinaryToWriter
    );
  }
};
 ...
 */
proto.sk8l.JobList.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.k8s.io.api.batch.v1.Job>} */ (
    jspb.Message.getRepeatedWrapperField(this, k8s_io_api_batch_v1_generated_pb.Job, 1));
};


/**
 * @param {!Array<!proto.k8s.io.api.batch.v1.Job>} value
 * @return {!proto.sk8l.JobList} returns this
*/
proto.sk8l.JobList.prototype.setItemsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 */
proto.sk8l.JobList.prototype.addItems = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.k8s.io.api.batch.v1.Job, opt_index);
};
 ...
 * @return {!proto.sk8l.JobList} returns this
 */
proto.sk8l.JobList.prototype.clearItemsList = function() {
 ...
 * @return {!Object}
 */
proto.sk8l.MappedJobs.prototype.toObject = function(opt_includeInstance) {
  return proto.sk8l.MappedJobs.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.sk8l.MappedJobs} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sk8l.MappedJobs.toObject = function(includeInstance, msg) {
  var f, obj = {
    joblistsMap: (f = msg.getJoblistsMap()) ? f.toObject(includeInstance, proto.sk8l.JobList.toObject) : []
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.sk8l.MappedJobs}
 */
proto.sk8l.MappedJobs.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.sk8l.MappedJobs;
  return proto.sk8l.MappedJobs.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.sk8l.MappedJobs} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.sk8l.MappedJobs}
 */
proto.sk8l.MappedJobs.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = msg.getJoblistsMap();
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.sk8l.JobList.deserializeBinaryFromReader, "", new proto.sk8l.JobList());
         });
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.sk8l.MappedJobs.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.sk8l.MappedJobs.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.sk8l.MappedJobs} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sk8l.MappedJobs.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getJoblistsMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(1, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.sk8l.JobList.serializeBinaryToWriter);
  }
};
 ...
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.sk8l.JobList>}
 */
proto.sk8l.MappedJobs.prototype.getJoblistsMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.sk8l.JobList>} */ (
...
/**
 * Clears values from the map. The map will be non-null.
 * @return {!proto.sk8l.MappedJobs} returns this
 */
proto.sk8l.MappedJobs.prototype.clearJoblistsMap = function() {
  this.getJoblistsMap().clear();
  return this;
};
